...
optimizer = dict(type='SGD', lr=0.0025, momentum=0.9, weight_decay=0.0001)  #学习率的设置尤为关键：lr = 0.00125*batch_size
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_r50_fpn_1x_Msize'
#load_from = None
#load_from = './checkpoints/cascade_coco_pretrained_weights_classes_21.pth'
load_from = './checkpoints/cascade_rcnn_r50_fpn_1x_20190501-3b6211ab.pth'
#resume_from = None
resume_from = "./work_dirs/cascade_rcnn_r50_fpn_1x_Msize/epoch_9.pth"
workflow = [('train', 1)]
