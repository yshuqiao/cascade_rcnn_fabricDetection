...
class Fabric2COCO:
    ...
    def __init__(self, mode="train"):
        ...
        self.ann_id = 0
        self.mode = mode
        if not os.path.exists("coco2/images/{}".format(self.mode)):
            os.makedirs("coco2/images/{}".format(self.mode))
...
'''转换有瑕疵的样本为coco格式'''
# img_dir = "/data1/bupi_data/guangdong1_round1_train1_20190818/defect_Images"
# anno_dir = "/data1/bupi_data/guangdong1_round1_train1_20190818/Annotations/anno_train.json"
img_dir = "/data1/bupi_data/guangdong1_round1_train2_20190828/defect_Images"
anno_dir = "/data1/bupi_data/guangdong1_round1_train2_20190828/Annotations/anno_train.json"
fabric2coco = Fabric2COCO()
train_instance = fabric2coco.to_coco(anno_dir, img_dir)
if not os.path.exists("coco2/annotations/"):
    os.makedirs("coco2/annotations/")
fabric2coco.save_coco_json(train_instance, "coco2/annotations/" + 'instances_{}.json'.format("train"))